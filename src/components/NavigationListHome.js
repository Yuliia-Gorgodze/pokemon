...
const  onClickAbility =()=>{
    dispatch(page('ability'))
}
return (
    ...
    <ul className={styles.list}>
        ...
        <li >
            ...
            <NavLink to="/gallery" onClick={onClickGallery} className={styles.button} activeClassName={styles.buttonActive}>галерея</NavLink>
        </li>
        <li>
            <div className={styles.cardGallery}>
                <img style={{width: '100%' }} src={imgGallery} alt='favorite'/>
            </div>
            <NavLink to="/favorite" className={styles.button} onClick={onClickFavorite} activeClassName={styles.buttonActive}>любимые</NavLink>
        </li>
